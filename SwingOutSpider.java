...
public class SwingOutSpider extends Spider implements PartyAnimals
{
	public SwingOutSpider( int x, int y )
	{
		super( x, y );
		numStates = 9;
		state = 0;
	...
	public void step2()
	{
		headCenter.x = web.x - 10;
		headCenter.y = web.y + webLength + 30;
		neck.x = headCenter.x;
		neck.y = headCenter.y + headRadius;
		bodyCenter.x = neck.x;
		bodyCenter.y = neck.y + bodyRadius;
